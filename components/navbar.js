    ...
    return (
        <div className='bg-gradient-to-br from-blue-100 h-min align-center to-white px-6 flex flex-col lg:flex-row justify-between align-center align-middle border-b-2 border-b-gray-300 lg:border-b-0 pb-1'>
            <div className='flex flex-row justify-center'>
                ...
                <div className='flex flex-col justify-center align-center'><span className='italic text-xs tracking-wider px-1 text-yellow-800 font-bold bg-gradient-to-br from-blue-100 to-blue-200 p-0.5 rounded-lg text-center'>Providing help to those who need it, come on the 10<sup>th</sup> July starting at 11.30.</span></div>
            </div>
