        ...
        <Layout>
            <div className='grid place-items-center'>
                ...
                <div className='flex flex-row flex-wrap'>
                    <Person name="Dorota" email="dloszczykow@gmail.com" />
                    <Person name="Francois" email="francoisvogel@bsnstudent.nl" />
                    <Person name="Romain" email="romainkrummenacher@bsnstudent.nl" />
                </div>
            </div>
        </Layout>
    )
