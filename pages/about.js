        ...
        <Layout>
            <div className='grid place-items-center'>
                ...
                <div className='flex flex-row flex-wrap'>
                    ...
                    <Person name="Francois" title="Web/communications coordinator" email="francois.g.vogel@gmail.com" tel="--" />
                    <Person name="Romain" title="Activities coordinator" email="--" tel="--" />
                </div>
            </div>
        </Layout>
    )
